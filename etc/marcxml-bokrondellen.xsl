...
<xsl:stylesheet version="1.0" 
    ...
    <xsl:template match="marc:record">
        ...
        <xsl:if test="(count(marc:datafield[@tag = '020']/marc:subfield[@code = 'a']) = 1 or count(marc:datafield[@tag = '022']/marc:subfield[@code = 'a']) = 1) and $encoding_level != 5 and $encoding_level != 8">
            <artikel>
                ...
                <xsl:apply-templates select="marc:datafield[@tag = '082' and marc:subfield[@code = 'a']]/marc:subfield[@code = 'a']"/>
                <xsl:apply-templates select="marc:datafield[@tag = '084' and marc:subfield[@code = 'a'] and marc:subfield[@code = '2' and starts-with(.,'kssb')]]/marc:subfield[@code = 'a']"/>
    ...
    <xsl:template match="marc:datafield[@tag = '082']/marc:subfield[@code = 'a']">
